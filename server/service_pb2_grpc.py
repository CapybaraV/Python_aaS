...
class ScriptServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteScript = channel.unary_unary(
                '/scriptservice.ScriptService/ExecuteScript',
                request_serializer=service__pb2.ScriptRequest.SerializeToString,
                response_deserializer=service__pb2.ScriptResponse.FromString,
...
def add_ScriptServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExecuteScript': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.ScriptResponse.SerializeToString,
            ),
    }
...
class ScriptService(object):
    ...
    def ExecuteScript(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            service__pb2.ScriptResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
